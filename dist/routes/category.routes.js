...
router.get("/categories", [checkJwt_1.checkJwt, (0, checkRole_1.checkRole)(["admin", "product admin", "user"])], category_controller_1.getCategories);
...
router.post("/category", [checkJwt_1.checkJwt, (0, checkRole_1.checkRole)(["admin", "product admin"])], category_controller_1.createCategory);
